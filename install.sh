...
echo "Installing AWS Cost Analyzer requirements..."
...
if [ $? -eq 0 ]; then
    ...
    echo "   cp key.json.example key.json"
    ...
    echo ""
    echo "3. Replace key.json with your Google service account key"
    echo "   (Download from Google Cloud Console)"
    echo ""
    echo "4. Run the script:"
    echo "   python3 cost_analyzer.py"
    echo ""
else
    echo ""
